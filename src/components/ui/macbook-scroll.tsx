...
export const MacbookScroll = ({
  ...
  // Add a new variable to control the screen scale
  const screenScale = useTransform(scrollYProgress, [0, 1], [0.5, 1]);
  const words=[
    'imagination',
    'prespective',
    'achievment',
  ...
  return (
    <div
      ...
      <motion.h2
        ...
        className="dark:text-white text-neutral-800 text-3xl font-semi-bold mb-20 text-center">
        {title || (
          <span className=" text-slate-800">
            Where <FlipWords words={words} className=" w-44" /> comes true<br /> Order your package.
          </span>
        )}
      </motion.h2>
      {/* Lid */}
  ...
  return (
    <div className="relative [perspective:800px]">
      ...
      <motion.div
        ...
        <img src={img} alt="this is is an image" />
      </motion.div>
    </div>
  );
};
